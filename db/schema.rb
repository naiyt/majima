...
ActiveRecord::Schema.define(version: 2021_01_05_011459) do
  ...
  create_table "videos", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.datetime "started_recording_at", null: false
    t.index ["started_recording_at"], name: "index_videos_on_started_recording_at"
  end
